...
object MultiplesOf3and5 {
  def main(args: Array[String]) {
    val sum = MultiplesOf3and5.multiplesOf3And5(1000)
    println("P001: " + sum)
  }
  ...
  // e.g. Sum(1*3, 2*3, 3*3...n*3) = 3 * Sum(1, 2, 3...n) -- Factor out the 3
  //
  ...
  private def calculateSumBelowLimit(upperLimit: Int, k_value: Int) = {
    val n_value = (upperLimit - 1) / k_value // upperLimit is not included, i.e. find the sum below the upperLimit
